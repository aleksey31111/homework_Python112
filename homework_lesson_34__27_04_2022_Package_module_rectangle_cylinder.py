...
print(f"Длина окружности: {round(2 * pi * rc1.base_radius, 2)}")
print(f"Длина окружности: {round(2 * pi * rc2.base_radius, 2)}")
print(f"Длина окружности: {round(2 * pi * rc3.base_radius, 2)}")
print(f"Длина окружности: {round(2 * pi * rc4.base_radius, 2)}")

print(f"Площадь круга: {round(2 * pi * pow(rc1.base_radius, 2), 2)}")
print(f"Площадь круга: {round(2 * pi * pow(rc2.base_radius, 2), 2)}")
print(f"Площадь круга: {round(2 * pi * pow(rc3.base_radius, 2), 2)}")
print(f"Площадь круга: {round(2 * pi * pow(rc4.base_radius, 2), 2)}")
